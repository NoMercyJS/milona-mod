...
let iltifatlar = [
  ...
  "Seni gören kelebekler, güzelliğin karşısında mest olur..",
  "Parlayan gözlerin ile karanlık gecelerime ay gibi doğuyosun..",
  "Cehennem buz tutana kadar benim olmaya ne dersin ? :wink:",
  "Huzur kokuyor geçtiğin heryer.",
  "Ay dünyaya ben sana tutuldum..",
  "Annen arı mı, bal gibi çocuk doğurmuş :face_with_hand_over_mouth:",
  "En güzel manzaramsın, izlemeye doyamadığım..",
  ...
  "Pşt, Fıstık naber?",
  "Bir insan aşık olunca kalbinr söz geçirmiyorum, olmuyo..Kalbiğğmm",
  "O kadar güzel gülüyosun ki sevmesem ziyan olucakti !",
