...
module.exports = async (member) => {
  ...
  .setDescription(`
  <a:mln_yildiz:815182914950135839> **Sunucumuza Hoşgeldin** ${member.toString()} **Seninle Beraber__${member.guild.memberCount}__Kişiyiz.** \n
  <a:mln_yildiz:815182914950135839> **Kayıt olmak için tag almamlı veyea boost basmalısın.** \n
  <a:mln_yildiz:815182914950135839> <@&${config.yetkilirol}> <@&${config.kayıtcırol}> **Rolündeki Yetkililer Seninle İlgilenecektir** \n
  <a:mln_yildiz:815182914950135839> **Hesabın** **${hesapzaman}** **tarihinde Açılmış**`);
